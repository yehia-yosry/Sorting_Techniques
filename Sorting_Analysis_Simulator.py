...
print("Kth Element => Input Array [85, 43, 78, 22, 54, 50, 100, 34, 47, 45]. 5th smallest element:")
array = [85, 43, 78, 22, 54, 50, 100, 34, 47, 45]
print(QSK(array,5, 0, len(array)-1))
print("Kth Element => Input Array [23,78,45,8,32,56]. 3rd smallest element:")
...
def time_complexity(input_sizes):
    ...
    for i in range(0, len(input_sizes)):
        ...
        time_merge.append(MS(arr)[1])
        time_quick.append(QS(arr)[1])
        time_heap.append(HS(arr)[1])
    return time_bubble, time_insertion, time_selection, time_merge, time_quick, time_heap
...
merge_sort_time = time_[3]
quick_sort_time = time_[4]
heap_sort_time = time_[5]

# Ploting Graphs Using matplotlib
plt.plot(input_sizes, bubble_sort_time, marker='o',
         linestyle='-', color='#e41a1c', label='Bubble Sort')
plt.plot(input_sizes, insertion_sort_time, marker='o',
         linestyle='-', color='#377eb8', label='Insertion Sort')
plt.plot(input_sizes, selection_sort_time, marker='o',
         linestyle='-', color='#4daf4a', label='Selection Sort')
plt.plot(input_sizes, merge_sort_time, marker='o',
         linestyle='-', color='#984ea3', label='Merge Sort')
plt.plot(input_sizes, quick_sort_time, marker='o',
         linestyle='-', color='#ff7f00', label='Quick Sort')
plt.plot(input_sizes, heap_sort_time, marker='o',
         linestyle='-', color='#ffff33', label='Heap Sort')
